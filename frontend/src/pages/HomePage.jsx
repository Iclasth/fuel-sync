...
export const HomePage = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 font-sans text-gray-800">
      ...
      <aside className="w-64 bg-[#6b46c1] text-white flex flex-col shadow-2xl relative z-10">
        <div className="h-20 flex items-center px-8 border-b border-purple-500/30">
          <h1 className="text-2xl font-bold tracking-widest">NAVROTAS</h1>
        </div>
        
        <nav className="flex-1 px-4 py-6 space-y-2">
          {/* O Início está com fundo branco translúcido para indicar a aba ativa */}
      ...
      <main className="flex-1 flex flex-col h-screen overflow-y-auto">
        <div className="p-8 space-y-8 max-w-6xl mx-auto w-full">
          ...
          {/* Banner de Boas-vindas (Fundo Branco) */}
          <section className="bg-white border border-gray-200 rounded-2xl p-6 md:p-8 shadow-sm">
            <div className="space-y-5">
              ...
              <p className="text-gray-500 max-w-2xl text-base leading-relaxed">
                Você está conectado ao painel operacional NAVROTAS. Utilize o menu lateral para iniciar um abastecimento, gerenciar seus endereços ou acompanhar seus pedidos em tempo real.
              </p>
            </div>
          </section>

          {/* Cards de Informação e Status */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow space-y-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-800">Perfil</h3>
                  <p className="text-xs text-gray-500 font-medium">Dados do usuário</p>
                </div>
              </div>
              <div className="space-y-3 pt-4 border-t border-gray-100 text-sm">
                ...
                <div className="flex justify-between items-center">
                  <span className="text-gray-500 font-medium">Nível (RBAC)</span>
                  <span className="font-bold uppercase text-[#6b46c1]">{user?.role || 'CLIENTE'}</span>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow space-y-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-800">Sistema</h3>
                  <p className="text-xs text-gray-500 font-medium">Conexão com Servidor</p>
                </div>
              </div>
              <div className="space-y-3 pt-4 border-t border-gray-100 text-sm">
                <div className="flex justify-between items-center">
                  <span className="text-gray-500 font-medium">API Base</span>
                  <span className="bg-gray-100 px-2 py-1 rounded text-gray-600 font-mono text-xs">/api/v1</span>
                </div>
                <div className="flex justify-between items-center">
            ...
            <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow space-y-5">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="text-lg font-bold text-gray-800">Módulos</h3>
                  <p className="text-xs text-gray-500 font-medium">Implementações Recentes</p>
                </div>
              </div>
              <div className="space-y-3 pt-4 border-t border-gray-100 text-sm text-gray-600 font-medium">
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-green-500 shrink-0" />
                  <span>Novo Design System Light</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle2 className="w-4 h-4 text-green-500 shrink-0" />
                  <span>Navegação Lateral Fixa</span>
                </div>
              </div>
            </div>
